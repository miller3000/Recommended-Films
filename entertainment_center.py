...
celine_and_julie = media.Movie(
    "Celine and Julie Go Boating",
    "Two friends in Paris try to change the world around them.",
    ("https://upload.wikimedia.org/wikipedia/en/3/34/Celine_and_Julie_Go_"
      "Boating_poster.jpg"),
...
woman_dunes = media.Movie(
    "Woman in the Dunes",
    "Two strangers are trapped in a sand pit in an isolated village.",
    ("https://upload.wikimedia.org/wikipedia/en/1/11/Woman_in_the_Dunes"
      "_poster.jpg"),
...
ikiru = media.Movie(
    "Ikiru",
    "A dying bureaucrat searches for meaning in his life.",
    ("https://upload.wikimedia.org/wikipedia/commons/thumb/3/3a/Ikiru_poster"
      ".jpg/800px-Ikiru_poster.jpg"),
